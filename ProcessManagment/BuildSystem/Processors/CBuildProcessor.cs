...
{
    internal class CBuildProcessor : BuildProcessor
    {
        private const string BUILD_ARGS = "g++ program.c";
        ...
        private const string SRC_FILE_NAME = "program.c";
        ...
        internal CBuildProcessor(string workingDir) : base(workingDir) { }
